...
If the app noticeably lags while loading or scrolling the list, you can disable achievement icon loading in the **Icons** section or switch the performance mode to **Economy**. This reduces the load and makes the interface faster.
...
# Steam Achievement Inspector (SAI) - Русский
